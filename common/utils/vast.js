...
exports.downloadVastAndWrappersAsync = exports.downloadVastAndWrappersSync = exports.createVastWithBuilder = exports.buildVast = void 0;
...
function downloadVastAndWrappersSync(vastUrl, options) {
  ...
  var currentVast;
  do {
    var vastRawContent = fetch_1.fetchUrl({
      url: vastUrl,
      syncInBrowser: true
    });
...
function downloadVastAndWrappersAsync(
  vastUrl,
  options,
  callback,
  actualDownloadedVasts
) {
