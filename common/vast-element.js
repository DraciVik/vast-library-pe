...
var VastElement = /** @class */ (function () {
    function VastElement(name, parent, baseInfos, contentOrAttributes, attributesIfContent) {
        if (name === void 0) { name = "root"; }
        if (parent === void 0) { parent = null; }
        if (baseInfos === void 0) { baseInfos = { attrs: [] }; }
        this.parent = parent;
        this.name = name;
    ...
    VastElement.prototype.getAttr = function (attributeName) {
        ...
        var lowerCasedAttrs = Object.keys(this.getValidAttrs()).reduce(function (prev, next) {
        ...
        if (this.infos.attrs === "all") {
            ...
            return Object.keys(this.attrs).reduce(function (prev, next) {
                ...
                if (_this.infos.attrs.indexOf(next) !== -1) {
                    return __assign({}, prev, (_a = {}, _a[next] = _this.attrs[next], _a));
                }
                else {
                    logs_1.warnOrThrow("WARNING: the attribute \"" + next + "\" does not exists in \"" + _this.name + "\" Tag. It was ignored.\n            Here is the allowed list: " + _this.infos.attrs, _this.options);
                    return prev;
                }
            }, {});
        }
    ...
    VastElement.prototype.getAttrs = function () {
        logs_1.logWarn("“getAttrs()“ method is deprecated, use getValidAttrs() instead.");
    ...
    VastElement.prototype.attachCustomTag = function (tagName, contentOrAttributes, attributesIfContent) {
        var newElem = new VastElement(tagName, this, { attrs: "all" }, contentOrAttributes, attributesIfContent);
        this.childs.push(newElem);
        return newElem;
    };
    VastElement.prototype.addCustomTag = function (tagName, contentOrAttributes, attributesIfContent) {
        return this.attachCustomTag(tagName, 
        // allow fallback on attachCustomTag overload
        contentOrAttributes, attributesIfContent).and();
    };
    // undocumented
    ...
    VastElement.prototype.getJson = function () {
        ...
        return __assign({}, jsonVast, childCode);
    };
    ...
    VastElement.prototype.toXml = function () {
        ...
        //   this.validate();
        // }
        return xml_js_1.js2xml(__assign({}, xmlDeclaration, this.getRoot().getJson()), __assign({ compact: true }, this.options));
    };
    ...
    VastElement.prototype.getChilds = function (name) {
        return this.childs.filter(function (c) { return c.name === name; });
    };
    ...
    VastElement.prototype.get = function (arrayOfTagNames, fromRoot) {
        if (arrayOfTagNames === void 0) { arrayOfTagNames = []; }
    ...
    VastElement.prototype.parseOptions = function (options) {
        this.options = __assign({ cdata: true, logWarn: true, spaces: 2, throwOnError: false }, options);
    };
    // undocumented
